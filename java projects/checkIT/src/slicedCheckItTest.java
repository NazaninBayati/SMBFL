...
public class slicedCheckItTest {
	 ...
	 */
		...
		public void test1()
		{
			...
			String result = slicedCheckIt.checkIt(false, true, false);
	 ...
	 */
		...
		public void test2()
		{
			...
			String result = slicedCheckIt.checkIt(true, true, false);
	 ...
	 */
		...
		public void test3()
		{
			...
			String result = slicedCheckIt.checkIt(true, false, true);
			assertEquals("P is true" ,result);
	 ...
	 */
		...
		public void test4()
		{
			...
			String result = slicedCheckIt.checkIt(true, false, false);
			assertEquals("P isn't true" ,result);
	 ...
	 */
		...
		public void test5()
		{
			...
			String result = slicedCheckIt.checkIt(true, true, true);
			assertEquals("P is true" ,result);
