/*
 * ExtNullPointerException.java: Extended standard throwable for stacks
 *
...
/**
 * Implementation of the {@link ThrowableList} interface for the well-knwon JDK 
 * {@link java.lang.NullPointerException}.
 *
 * @version	1.00, 2001/06/26
 * @author 	Heiko Blau
 */
public class ExtNullPointerException extends NullPointerException implements ThrowableList, ExceptionList
{
  //---------------------------------------------------------------------------
   ...
   */
  public ExtNullPointerException(String msg) {
    this(null, msg, null);
  }
   ...
   */
  public ExtNullPointerException(Throwable ex) {
    this(ex, null, null);
  }
   ...
   */
  public ExtNullPointerException(Throwable ex, String msg) {
    this(ex, msg, null);
  }
   ...
   */
  public ExtNullPointerException(String fmt, Object[] args) {
    this(null, fmt, args);
  }
   ...
   * @param args  arguments for the given format string
   */
  public ExtNullPointerException(Throwable ex, String fmt, Object[] args) {
    super(fmt);
