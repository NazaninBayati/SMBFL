...
public interface Tokenizer
{
  ...
  public static final short F_KEEP_DATA             = 0x0040;

  public static final short F_COUNT_LINES           = 0x0020;

  public static final short F_ALLOW_NESTED_COMMENTS = 0x0100;

  public static final short F_PARSE_NUMBERS         = 0x0080;
#else  
  public static final short F_NO_CASE               = 0x0001;
